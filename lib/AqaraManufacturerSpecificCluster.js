...
const AQARA_ATTRIBUTES = {
  ...
  104: { name: 'state4' }, // type: ZCLDataTypes.uint16
  105: { name: 'state5' }, // type: ZCLDataTypes.uint16
  106: { name: 'state6' }, // type: ZCLDataTypes.uint16

  // TODO: these are currently unknown or not used
  149: { name: 'consumption', type: ZCLDataTypes.single },
  150: { name: 'voltage', type: ZCLDataTypes.single },
  151: { name: 'current', type: ZCLDataTypes.single },
  152: { name: 'power', type: ZCLDataTypes.single },
...
const ATTRIBUTES = {
  ...
  aqaraTRVWindowOpenDetection: {
    id: 627, // 0x0273
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
  aqaraTRVValveDetection: {
    id: 628, // 0x0274
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
  ...
  aqaraCurtainMotorState: {
    id: 1028, // 0x0404
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
  aqaraCurtainCalibrationActions: {
    id: 1031, // 0x0407
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
  ...
  aqaraCurtainTargetPosition: {
    id: 1055, // 0x041F
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
  aqaraCurtainLastCommand: {
    id: 1056, // 0x0420
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
  aqaraCurtainMoveState: {
    id: 1057, // 0x0421
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
  aqaraCurtainManualOpen: {
    id: 1061, // 0x0425
    type: ZCLDataTypes.uint16,
    manufacturerId: 0x115f,
  },
  aqaraCurtainCalibrationPoints: {
    id: 1062, // 0x0426
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
  aqaraCurtainHookActions: {
    id: 1063, // 0x0427
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
  aqaraCurtainHookState: {
    id: 1064, // 0x0428
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
  aqaraCurtainLightSensor: {
    id: 1065, // 0x0429
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
  aqaraCurtainTrackType: {
    id: 1068, // 0x042C
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
  aqaraCalibrationMode: {
    id: 1075, // 0x0433
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
  aqaraLEDStripMinBrightness: {
    id: 1301, // 0x0515
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
  aqaraLEDStripMaxBrightness: {
    id: 1302, // 0x0516
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
  ...
  aqaraLEDStripAudioEffect: {
    id: 1309, // 0x051d
    type: ZCLDataTypes.uint32,
    manufacturerId: 0x115f,
  },
  aqaraLEDStripAudioSensitivity: {
    id: 1310, // 0x051e
    type: ZCLDataTypes.uint8,
    manufacturerId: 0x115f,
  },
