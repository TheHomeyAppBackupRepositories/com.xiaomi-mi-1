  ...
  async onSettings({ oldSettings, newSettings, changedKeys }) {
    ...
    if (changedKeys.includes('save_state')) {
      const result = await this.zclNode.endpoints[this.getClusterEndpoint(XiaomiBasicCluster)].clusters[XiaomiBasicCluster.NAME]
        .writeAttributes({ xiaomiPowerOutageMemory: newSettings.save_state });
      this.log('SETTINGS | Write Attribute - Xiaomi Manufacturer Specific Cluster - xiaomiPowerOutageMemory', newSettings.save_state, 'result:', result);
    }
  }
